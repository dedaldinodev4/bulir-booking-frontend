...
export default function BookingsProviderTable() {
  ...
  const { data, isLoading, isFetching } = useBookings({
    page,
    limit,
    providerId: session ? session.user?.id : undefined
  })
    ...
    <>
      ...
      >
        <div className="text-center">
          ...
          <p className="text-sm leading-6 text-gray-500 dark:text-gray-400">
            Está ação irá finalizar o serviço, e assumir que foi realizado com sucesso e entregue ao cliente com todos requisitos e exigências inicialmente propostas pelo cliente .
          </p>
      ...
      >
        <div className="text-center">
          ...
          <p className="text-sm leading-6 text-gray-500 dark:text-gray-400">
            Está ação encerra o serviço solicitado, e devolve o dinheiro do cliente caso já tenha confirmado a reserva.
            Haverá um estorno da sua carteira para carteira do cliente.
          </p>
